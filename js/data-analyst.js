...
function initialize(members){
    ...
    // segun pag HTML, calcula Tablas inferiores con funcion "preparando" pasando (datos, direccion orden, campo criterio orden)
    // que nos devuelve los datos precisos que estemos buscando para cada cuadrante
    // y escribirá en el HTML, con llamada a funcion cargarTablaAnalisis pasando (arrTemporal y sitio donde escribirla)
